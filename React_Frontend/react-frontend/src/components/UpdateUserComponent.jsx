...
class UpdateUserComponent extends Component {
    ...
    updateUser = (event) => {
        ...
        let user = {
            nombre: this.state.nombre, apellido: this.state.apellido, latitud: this.state.latitud, longitud: this.state.longitud, zona: this.state.zona,
        };
    ...
    componentDidMount() {
        UserService.getUserById(this.state.id).then(res => {
            let user = res.data;
            this.setState({ nombre: user.nombre, apellido: user.apellido, latitud: user.latitud, longitud: user.longitud });
        });
    }
                        ...
                        <div className='card col-md-6 offset-md-3 offset-md-3'>
                            ...
                            <div className='card-body'>
                                <form>
                                    ...
                                    <button className='btn btn-success' onClick={this.updateUser.bind(this)}>Editar</button>
